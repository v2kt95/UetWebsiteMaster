                            ...
                            <ul>
                                ...
                                <li>
                                    <article style="background-color: <?php echo $cs_xmlObject->var_cp_course_color;?>">
                                        <h5><a href="<?php the_permalink();?>" class="colrhovr"><?php echo mb_substr(get_the_title(),0, 25); if(strlen(get_the_title())>25){echo '...';}?></a></h5>
                            	...
                            	<?php if($cs_node->var_pb_course_view == 'courses-gridview'){?>
                                		<div class="event-texttop">
                                            <h2 class="cs-post-title">
                                                <a href="<?php the_permalink();?>" class="colrhvr"><?php echo mb_substr(get_the_title(),0, 40); if(strlen(get_the_title())>40){echo '...';}?></a>
                                            </h2>
										</div>	
									<?php } 
