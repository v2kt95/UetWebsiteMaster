        ...
        <div class="option-sec row">
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <div class="on-off"><input type="checkbox" name="post_social_sharing" value="on" class="myClass" <?php if(isset($post_social_sharing) && $post_social_sharing =='on')echo "checked"?> /></div>
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <div class="on-off"><input type="checkbox" name="post_author_description" value="on" class="myClass" <?php if(isset($post_author_description) && $post_author_description =='on')echo "checked"?> /></div>
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                    	<input type="text" name="related_posts_title" value="<?php echo isset($related_posts_title) ? $related_posts_title : ''; ?>" />
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <div class="on-off"><input type="checkbox" name="post_related_posts" value="on" class="myClass" <?php if(isset($post_related_posts) && $post_related_posts =='on')echo "checked"?> /></div>
